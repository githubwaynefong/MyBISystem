...
public class IpParser4LocalCache {
	/*
	 * IP地址解析器
	 */
	//纯真IP数据库文件
...
//	public void setPath(String path) { this.DbPath = path; }
	...
	/*
	 * @param HDFSCachePath 分布式文件系统缓存文件路径（任务节点本地路径）
	 */
	public static void setDbPath(String HDFSCachePath) {
		DbPath = HDFSCachePath;
	}
	...
	public static void main(String[] args) {
		IpParser4LocalCache.setDbPath("./cz88/qqwry.dat");
